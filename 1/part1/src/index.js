...
const App = (props) => {
    ...
    const setToValue = (value) => { 
        ...
        // that is b/c we would call a function which calls itself and votes to itself infinitely
...
const App = ({anecdotes}) => {
    ...
    const updateVote = () => {
        ...
        const currentVoteCounts = [...votes];
        ++currentVoteCounts[selected];
        setVotes(currentVoteCounts);

        if (currentVoteCounts[selected] > currentVoteCounts[max] ) {
            setMax(selected);
        }
